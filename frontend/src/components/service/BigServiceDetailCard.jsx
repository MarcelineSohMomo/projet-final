...
import GeolocalisationInfo from '../geolocalisation/GeolocalisationInfo';
              ...
              <div className="row">
                <div className="col-9">
                  <div className="categorie">
                    <span>Catégorie : </span>
                    <span>{service.categorie && service.categorie.name.toUpperCase()} </span>
                  </div>
                ...
                <div className="col-3 qualification">
                  ...
                  <div className="Row my-3">
                    <div className="col">
                      <Link to={`/inbox/${service.providerId._id}`} >
                        <p className='contacter-fournisseur'> <FaFacebookMessenger style={{ color: 'gray', fontSize: '10px' }}/> <span> Ecrire au fournisseur</span> </p>
                      </Link>
                    </div>
                  </div>
                  <div className="Row my-3">
                    <div className="col">
                      <Link to={"#comments-body"}>
                        <p  className='laisser-commentaire'> <FaEdit style={{ color: 'gray', fontSize: '10px' }}/> <span> Laisser un commentaire</span> </p>
                      </Link>
                    </div>
                  </div>
                  <div className="Row my-3">
                    <div className="col">
                      <p onClick={e => handleSubmitOrder()}
                       ...
                       > 
                       <FaCheck style={{ color: 'gray', fontSize: '10px' }}/> <span>  Lancer une commande</span> </p>
                    </div>
                  </div>
                  <div className="Row my-3">
                    <div className="col">
                  ...
                  <GeolocalisationInfo geolocalisation={service.geolocalisation} />
                </div>
              </div>
              
            </div>
          </div>
          <FavoriteUpdate noteHasChanged={noteHasChanged} setNoteHasChanged={setNoteHasChanged} service={service}/>
