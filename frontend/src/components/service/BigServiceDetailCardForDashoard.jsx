              ...
              <div className="row">
                <div className="col-9">
                  <div className="categorie">
                    <span>Catégorie : </span>
                    <span>{service.categorie &&service.categorie.name &&  service.categorie.name.toUpperCase()} </span>
                  </div>
                ...
                <div className="col-3 qualification">
                  ...
                  <div className="Row my-3">
                    <div className="col">
                      <p style={{ color: 'gray', fontSize: '10px' }} className=' laisser-commentaire faire-commande'
                       > 
                        {service.others}
                       </p>
                    </div>
