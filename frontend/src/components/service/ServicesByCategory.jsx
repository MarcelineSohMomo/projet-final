          ...
          <div key={category._id}>
            ...
            <Row className='justify-content-center'>
              {services.map((service) => (
                !service.isDeleted && <Col md={3} key={service.id} className=" m-3">
                  <Link to={`/services/${service._id}`}>
                    <SmallServicesCard width={"200px"} height={"180px"} service={service} shadow={"box-shadow-service"} />
                  </Link>
                  <div className="row provider-content">
                    ...
                    <div className="col d-flex justify-content-center align-items-center provider-name">
                      <span> {service.providerId.lastname && service.providerId.lastname.toUpperCase()  } </span> &nbsp;&nbsp;
