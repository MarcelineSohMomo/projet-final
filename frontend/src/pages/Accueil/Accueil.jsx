      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col d-flex justify-content-center align-items-center h2">
            Trouver le votre parmi nos{" "}
            <span className="prestation-rec"> 10 + catégories </span>
          </div>
        </div>
        <br />
          ...
          <div style={{ width: "800px", height: "300px" }}>
            <div
              ...
              style={{
                width: "100%",
                height: "100%",
                background: `url(${yellowcard}) center center no-repeat`,
              }}
            >
              <h2 className="h2 m-2">Trouvez le talent qu’il vous faut</h2>
              <p className="text-center m-2" style={{ fontWeight: 100 }}>
                Aliquet sapien pretium rhoncus, adipiscing morbi adipiscing nisl
                nec. Felis <br /> aliquet et, phasellus est semper. Fringilla
                elit a aliquam pharetra quam.
              </p>
              <br />
              <Link to={"/inscription"}>
                <button
