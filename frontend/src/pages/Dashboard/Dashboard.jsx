...
const Dashboard = () => {
    ...
    const setDisplayCustomer = ()=>{
      return isconnected &&
      (roles.some((role) => role.name.value = 1));
    }
    const setDisplayArtisan = ()=>{
      return isconnected &&
      (roles.some((role) => role.value >= 2));
    }

    const setDisplayModerator = ()=>{
      return isconnected &&
      (roles.some((role) =>  role.value >= 3));
    }
    ...
    const activeNavLinkStyle = {
      ...
      boxShadow: "rgb(69, 223, 190) 0px 30px 60px -12px, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px"
    };
  return (
    <VerifyAuth>
              ...
              <Card.Body className='p-0' style={{ overflowY: "scroll" }}>
                <Nav className=" flex-column">
                  ...
                  {setDisplayModerator() && (
                    <>
                      <Nav.Item>
                        <Nav.Link className='dashboard-navlink' as={Link} to="/dashboard/allservices" 
                        style={
                      ...
                      <Nav.Item>
                        <Nav.Link className='dashboard-navlink' as={Link} to="/dashboard/statistics" 
                        style={
